...
<body>
	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center"><i>Find Your Cars For Rent!</i></h2>
	...
	<footer>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> Car Rental System - Brought To You By <a href= "http://code-projects.org/"> Projects </a>
		</div>
	</footer><!--  end footer  -->
